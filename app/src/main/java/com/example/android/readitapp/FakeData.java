...
public class FakeData
{
    ...
    private FakeData()
    {
        ...
        challenge = new Challenge("Harry Potter Challenge", AgeGroupsEnum.DRAGONS, new Date(2018,10,20), new Date(2018, 12,15),books,"Info is missing");
        ...
        users = new ArrayList<>();
        //changed users1 pass to 1 ""
        pswHash = appManager.md5("1");
        achievements = new Achievements();
        challengeParticipation = new ChallengeParticipation(challenges.get(0), 100);
        challengeParticipations.add(0, challengeParticipation);
        borrowedBooks = new ArrayList<Book>(Collections.singleton(new Book("Harry Potter1")));
        user = new User( 1, pswHash, "Edoardo", AgeGroupsEnum.DRAGONS, achievements, 50, borrowedBooks, challengeParticipations);
        users.add(user);
        ...
        user = new User( 2, pswHash, "Alessandro", AgeGroupsEnum.TIGERS, achievements, 173, borrowedBooks, challengeParticipations );
        users.add(user);
        ...
        user = new User( 3, pswHash, "Andreas", AgeGroupsEnum.BUNNIES, achievements, 4, borrowedBooks, challengeParticipations);
        users.add(user);
